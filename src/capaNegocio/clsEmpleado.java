...
public class clsEmpleado {
    ...
    public void registrarEmpleado(String dni, String apePaterno, String apeMaterno, String nombres, String sexo, String movil) throws Exception {
    String strSQL = "INSERT INTO empleado (dni_empleado, ape_paterno, ape_materno, nombres, sexo, movil) "
                  + "VALUES ('" + dni + "', '" + apePaterno + "', '" + apeMaterno + "', '" + nombres + "', '" + sexo + "', '" + movil + "')";
    try {
        objConectar.ejecutarBD(strSQL); // Ejecutar la consulta
    } catch (Exception e) {
    ...
    public void modificarEmpleado(String dni, String apePaterno, String apeMaterno, String nombres, String sexo, String movil) throws Exception {
        String strSQL = "UPDATE empleado SET ape_paterno = '" + apePaterno + "', ape_materno = '" + apeMaterno + "', nombres = '" + nombres + "', "
                + "sexo = '" + sexo + "', movil = '" + movil + "' WHERE dni_empleado = '" + dni + "'";
        try {
            objConectar.ejecutarBD(strSQL);
        } catch (Exception e) {
