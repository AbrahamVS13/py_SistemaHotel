...
public class clsHabitacion {
    ...
    public ResultSet listarHabitaciones() throws Exception {
        // Realiza una unión entre la tabla habitacion y cate_habitacion para obtener el nombre de la categoría
        strSQL = "SELECT h.habitacion_id, h.estado_hab, h.num_camas, c.nombre_categoria " +
                 "FROM habitacion h " +
