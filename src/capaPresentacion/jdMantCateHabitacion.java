...
public class jdMantCateHabitacion extends javax.swing.JDialog {
    ...
    try {
        ...
        tblCateHab.getColumnModel().getColumn(0).setPreferredWidth(50); // Categoría ID
        tblCateHab.getColumnModel().getColumn(1).setPreferredWidth(300); // Nombre de la Categoría
        tblCateHab.getColumnModel().getColumn(2).setPreferredWidth(100); // Precio de la Categoría

        // Alinear el precio a la derecha
        DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
        rightRenderer.setHorizontalAlignment(SwingConstants.RIGHT);
        tblCateHab.getColumnModel().getColumn(2).setCellRenderer(rightRenderer);
    } catch (Exception ex) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnModificar, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
