...
import capaPresentacion.jdMantEmpresa;
import capaPresentacion.jdMantPersona;
...
public class jdMantCliente extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Añadir Empresa");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        jdMantPersona objPersona = new jdMantPersona(this, true); // 'this' es el JDialog actual
        objPersona.setLocationRelativeTo(this); // Centrar el segundo JDialog con respecto al actual
        objPersona.setVisible(true); // Mostrar el segundo JDialog
