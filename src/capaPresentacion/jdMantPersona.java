...
public class jdMantPersona extends javax.swing.JDialog {
    ...
    public jdMantPersona(java.awt.Window parent, boolean modal) {
    ...
    private void tblPersonasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPersonasMouseClicked
        // TODO add your handling code here:
        txtDNI.setText(String.valueOf(tblPersonas.getValueAt(tblPersonas.getSelectedRow(), 5)));
    ...
    private void listarPersonas() {
        try {
            ...
            while (rs.next()) {
                ...
                datos[0][1] = rs.getString("ape_paterno");
                datos[0][2] = rs.getString("ape_materno");
                datos[0][3] = rs.getString("sexo");
                datos[0][4] = rs.getString("fecha_nacimiento");
                datos[0][5] = rs.getString("numero_documento");
